package opentext.package_path.tests.qa11;
...
public class QAElevenPackage {
    static RemoteWebDriver driver;
    static WebDriverWait waiter;

    @Test()
    void googleSearchQAElevenTest() {
        ...
        Reporter.log("search on google 'QA Eleven' work properly");
    }
}
